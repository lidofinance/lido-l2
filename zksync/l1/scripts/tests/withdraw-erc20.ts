...
const L2_LIDO_BRIDGE_PROXY_ADDR = getAddressFromEnv('CONTRACTS_L2_LIDO_BRIDGE_PROXY_ADDR');
const L2_LIDO_BRIDGE_PROXY_INTERFACE = readInterface(l2Artifacts, 'L2ERC20Bridge');
...
async function main() {
    ...
    const l2BridgeContract = new Contract(L2_LIDO_BRIDGE_PROXY_ADDR, L2_LIDO_BRIDGE_PROXY_INTERFACE, zkWallet);
    ...
    const message = ethers.utils.solidityPack(
        ...
        [
            L1_LIDO_BRIDGE_PROXY_INTERFACE.getSighash(L1_LIDO_BRIDGE_PROXY_INTERFACE.getFunction('finalizeWithdrawal')),
            WALLET_ADDRESS,
