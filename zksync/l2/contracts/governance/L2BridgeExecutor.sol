...
abstract contract L2BridgeExecutor is BridgeExecutorBase, IL2BridgeExecutor {
  ...
  function __L2BridgeExecutor_init_unchained(address ethereumGovernanceExecutor) internal onlyInitializing {
    require(ethereumGovernanceExecutor != address(0), "Ethereum Governor address can't be zero");
