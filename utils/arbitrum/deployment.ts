...
export class ArbitrumERC20TokenGatewayDeployScriptsFactory {
  private readonly addresses: ArbitrumContractAddresses;

  constructor(addresses: ArbitrumContractAddresses) {
...
export class ArbotrumGatewayRoutersDeployScriptsFactory {
  private readonly addresses: ArbitrumContractAddresses;
...
export default {
  erc20TokenGateways(addresses: ArbitrumContractAddresses) {
    return new ArbitrumERC20TokenGatewayDeployScriptsFactory(addresses);
  },
  gatewayRouters(addresses: ArbitrumContractAddresses) {
    return new ArbotrumGatewayRoutersDeployScriptsFactory(addresses);
  },
};
